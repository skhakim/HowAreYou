...
export function ViewSignupRequest(props) {
...
export function ApproveFileRequest(props) {
    ...
    return (
        <div className='container'>
            <div className='test-name'><h1>Name: {responses['name']}</h1></div>
            <br/>
            <div className='test-name'><h1>Certificate: {responses['name']}</h1></div>
            <br/>
            <br/>
